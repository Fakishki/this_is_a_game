...
# old version works for all but the refactored choice WE CAN MAKE A NEW REFACTOR FOR CHOICE
...
# Legacy code from the previous app this new app was built off of
